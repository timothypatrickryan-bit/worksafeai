...
/**
 * LinkedIn Northeast Data Center Post + Auto-Generated Image
 * 
 * Generates both:
 * 1. Market commentary post
 * 2. Custom Recraft AI image
 * 
 * Saves both to .linkedin-current-post.json with image URL
 */
...
async function generateNortheastPost(postType = 'insight') {
  console.log(`\n📝 Generating Northeast DC/Fiber post with image...\n`);
  ...
  const postData = {
    ...
    status: imageResult.success ? "ready-to-post" : "ready-to-post-no-image"
  };
